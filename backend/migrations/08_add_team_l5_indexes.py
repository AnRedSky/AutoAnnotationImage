"""
迁移脚本 08: 团队管理 L5 索引优化 (v3.3.1)
=========================================
**MIGRATION_ID**: 08
**功能**:
- 优化 L4 阶段新增端点的潜在慢查询
- L4 端点:
  - GET /api/audit-logs: 多维度过滤
...
**执行顺序**: 08, 依赖 07 (team/team_member/annotation_log 表已建好, 字段齐全)
"""
import asyncio
...
MIGRATION_ID = "08"
MIGRATION_DESCRIPTION = "团队管理 L5 复合索引 (audit_log team_created/event_created/user_created/resource)"
...
async def run_migration() -> None:
    """runner 入口"""
    print(f"[{MIGRATION_ID}] 开始创建团队管理 L5 索引优化...")
