...
async def init_db():
    ...
    import app.tasks.model.team  # noqa: F401  (v3.3.0: team 表)
    import app.tasks.model.team_member  # noqa: F401  (v3.3.0: team 成员)
    import app.tasks.model.dataset_membership  # noqa: F401
    import app.tasks.model.audit_log  # noqa: F401
