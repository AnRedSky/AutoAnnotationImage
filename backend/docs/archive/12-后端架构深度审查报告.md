...
**位置**:
- [app/api/training.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/training.py) (57 KB / 约 1500 行)
- [app/api/image.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/image.py) (49 KB / 约 1300 行)
- [app/api/detection.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/detection.py) (39 KB / 约 1050 行)
- [app/api/export.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/export.py) (25 KB)
- [app/api/segmentation.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/segmentation.py) (24 KB)
- [app/api/auto_annotate.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/auto_annotate.py) (19 KB)
- [app/api/model.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/model.py) (18 KB)
- [app/api/dataset.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/dataset.py) (16 KB)
- [app/api/annotation.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/annotation.py) (16 KB)
...
**位置**: [app/services/](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/services/)
...
- 见 [training.py:333-349](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/api/training.py#L333-L349)
- 避免 Celery SUCCESS 状态下 `result.info` 是 return dict 而非 meta 的问题
- 但这是"打补丁", 没有从根上解决状态分散

**影响**:
- 任何一处逻辑遗漏, 前端 UI 就显示错误状态
- v2.5.15 修复了 5+ 个相关 Bug (见 [11-代码优化迭代记录.md](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/docs/11-代码优化迭代记录.md))
- 调试时需对照 4 处才能定位真实状态
...
**位置**:
- [app/workers/tasks.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/workers/tasks.py) (27 KB)
- [app/workers/detection_tasks.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/workers/detection_tasks.py) (32 KB)
- [app/workers/segmentation_tasks.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/workers/segmentation_tasks.py) (20 KB)
...
**位置**:
- [app/ml/train.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/ml/train.py) (24 KB)
- [app/ml/detection/yolo_train.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/ml/detection/yolo_train.py) (8 KB)
- [app/ml/segmentation/seg_train.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/ml/segmentation/seg_train.py) (7 KB)
...
**现状**:
- [core/exceptions.py](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/core/exceptions.py) 定义了 `AppException` + 4 个子类 (NotFoundError, PermissionDeniedError, ValidationError, ConflictError)
- 全局 `Exception` handler 在 [main.py:157-167](file:///d:/works/WorkBuddy/Myhome/系统实现/thesis-image-annotation/backend/app/main.py#L157-L167) 实现
